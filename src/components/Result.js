            ...
            <div className="container">
                <div className="row vh-100 align-items-center justify-content-center">
                    <div className="col-lg-6">
                        <div className={`text-light text-center p-5 rounded ${marks > (quizs.length * 5 / 2) ? 'bg-info' : 'bg-danger'}`}>
                            ...
                            <button onClick={startOver} className='btn py-2 px-4 btn-secondary fw-bold d-inline border'>Start Over</button>
                        </div>
                    </div>
                </div>
            </div>
